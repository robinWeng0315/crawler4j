 ...
 */
public class DiseaseCrawlController {
    private static final Logger logger = LoggerFactory.getLogger(DiseaseCrawlController.class);
     ...
     */
        controller.addSeed("https://www.baikemy.com/disease/list/3/0");
        controller.addSeed("https://www.baikemy.com/disease/list/5/0");

    /*
     * Start the crawl. This is a blocking operation, meaning that your code
     * will reach the line after this only when crawling is finished.
     */
        controller.start(DiseaseCrawler.class, numberOfCrawlers);
    }
}